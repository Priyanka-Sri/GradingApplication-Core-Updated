...
public class Admindetails {
	...
	public String toString() {
		return "Admindetails [Sname=" + Sname + ", REGNO=" + REGNO + ", ENG=" + ENG + ", MAT=" + MAT + ", COM=" + COM
				...
				+ Grade + ", NAME=" + NAME + ", PASSWORD=" + PASSWORD + ", sub=" + sub + ", max1=" + max1 + ", max2="
				+ max2 + ", max3=" + max3 + ", max4=" + max4 + ", min1=" + min1 + ", min2=" + min2 + ", min3=" + min3
				+ ", min4=" + min4 + ", grade1=" + grade1 + ", grade2=" + grade2 + ", grade3=" + grade3 + ", grade4="
				+ grade4 + ", MOBILENO=" + MOBILENO + ", ROLE=" + ROLE + "]";
	}
